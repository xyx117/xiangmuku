...
//员工完善信息
function yg_tianbiao(value, row, index) {
...
function wanshanxinxi(index) {
    ...
    if (row) {
        ...
        //var url = "/xiangmuguanli/wanshanxinxi?NoticeXmName='" + name + "'";
        //var url = "/xiangmuguanli/wanshanxinxi?NoticeXmName=" + name + "&xmid="+id;
...
function yg_tijiao(value, row, index) {
    ...
    //提交状态有两个值，一个是已提交，一个是未提交
    //if (jpxx == "1" && ccjx == "1" && xljx == "1" && csmx == "1" && lxpj == "1" && cgpz == "1" && zhi == "未提交") {
    //    return "<a href='javascript:void(0)' onclick='tijiao(" + index + ")' target='mainFrame'>提交</a>";
    //}
    if (zhi == "未提交") {
