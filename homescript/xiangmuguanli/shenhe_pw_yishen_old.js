...
$(function () {
    ...
    $("#dg_shpw_wc").datagrid({
        ...
        collapsible: true,
        method: 'post',
        url: '/xiangmuguanli/pw_shenhe_xm_wc',
        ...
        onLoadSuccess: function (data) {
            ...
            //提交
            $('.pwtijiao').linkbutton({ text: '提交', plain: true });
            $('.pwtijiao').addClass("c6");
            $('.pwtijiao_jin').linkbutton({ text: '提交', disabled: true });
...
function pw_tijiao(value, row, index) {
    ...
    var pwtijiao = row.pingweitijiao;
    if (pwtijiao == "未提交") {
        return "<a href='javascript:void(0)' style='width:95%' class='pwtijiao' onclick='pw_tj(" + index + ")' target='mainFrame'>提交</a>";
    } else {
        return "<a href='javascript:void(0)' style='width:95%' class='pwtijiao_jin'>提交</a>";
    }
};
