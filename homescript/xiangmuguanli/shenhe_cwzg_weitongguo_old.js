$(function () {
    ...
    var p_btg = $('#dg_shcwzg_btg').datagrid('getPager');
    ...
    $('#suoshuxueyuan').combobox({
        ...
        onChange: function (newValue, oldValue) {
            $('#dg_shcwzg_btg').datagrid('load', { "xiangmu": dgtitle, "searchquery": newValue });
        }
    });
...
function cwzgchakan_btg(index) {
    $('#dg_shcwzg_btg').datagrid('selectRow', index);
    var row = $('#dg_shcwzg_btg').datagrid('getSelected');
    if (row) {
        var name = row.XmName;
        var id = row.ID;
