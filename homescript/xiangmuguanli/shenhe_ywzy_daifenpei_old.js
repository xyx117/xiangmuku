...
$(function () {
    ...
    $("#dg_shywzy_dfp").datagrid({
        ...
        collapsible: true,
        method: 'post',
        url: '/xiangmuguanli/ywzy_shenhe_xm_dfp',
...
//业务专员 查看未通过  的脚本
//function ywzy_chakan(value, row, index) {
//    return "<a href='javascript:void(0)' style='width:60%' class='chakan' onclick='ywzychakan_btg(" + index + ")' target='mainFrame'>查看</a>";
//};
...
function ygxmrizhi(value, row, index) {
    //alert("sdf")
    return "<a href='javascript:void(0)' style='width:95%' class='rizhi' onclick='rizhichakan_btg(" + index + ")' target='mainFrame'>日志</a>";
